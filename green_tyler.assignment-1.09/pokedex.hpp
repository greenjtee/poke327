...
public:
    ...
    pokemon_t* get_random_pokemon();
    void get_random_pokemon_list(uint32_t count, std::vector<pokemon_t*> &list);
    uint32_t get_pokemon_level(int32_t y, int32_t x);
    void get_pokemon_moves(std::vector<pokemon_move_t *> &possible_moves);
    void get_pokemon_moves(pokemon *p);
    void get_pokemon_species(pokemon *p);
    void get_pokemon_stats(pokemon *p);
